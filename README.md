...
В репозитории также развивается [изолированный backend-каркас](backend/README.md)
на Django/DRF и PostgreSQL. Android-приложение к нему пока не подключено: Room
остаётся единственным источником данных мобильного прототипа.
