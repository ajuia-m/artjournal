...
> Статус: контракт реализации перед первыми предметными миграциями.
...
Публичный DRF endpoint, JWT, роли, Celery и Android-синхронизация в этот этап не
входят. Позднее они должны вызывать тот же импорт-сервис, не дублируя правила.
